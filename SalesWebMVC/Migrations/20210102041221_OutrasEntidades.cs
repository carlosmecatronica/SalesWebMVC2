    ...
    public partial class OutrasEntidades : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendasRegistros", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VendasRegistros_Vendedor_VendedorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VendasRegistros_VendedorId",
                table: "VendasRegistros",
                column: "VendedorId");
